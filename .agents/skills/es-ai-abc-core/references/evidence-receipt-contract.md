# ABCC evidence receipt contract

Every ABCC Core run must emit a machine-readable receipt containing `skillName`, `case`, `status`, `evidenceLevel`, `receiptPath`, `sourceRefs`, and `timestampUtc`.
